    ...
    internal static class ComparatorFactory
    {
        ...
        internal static Comparator GetComparator(Type type)
        {
            ...
            Debug.Fail(string.Format(
                @"Entity Framework should only use this method for primitive types. Try implementing a custom comparator for type {0} in SAY.Core project. Alternatively, implement IEquatable<T> in type {0}.",
                type));
